...
class _ViewState extends State<CustDashboardScreen> {
  String _timeString = "";
  ...
  void _getUserDetails() async {
    ...
    try {
      ...
      setState(() {
        ...
        _loadDashboardInfo();
        loadCustomerDetails(_loginUser.orgID);
      });
    } catch (ee) {
      print(ee.toString());
    }
  ...
  loadCustomerDetails(int orgID) {
    getAPI(CUSTOMER_LISTS + orgID.toString()).then((data) {
