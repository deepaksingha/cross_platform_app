              ...
              children: [
                ...
                Expanded(
                  child: Text(title, style: TextStyle(
                      fontSize: 16, color: active, fontWeight: FontWeight.w500
                  )),
                ),
  ...
  Widget createDetailWidget({required String title, required String desc}){
    return Column(
      ...
      children: [
        Container(
          child: Text(title, style: TextStyle(
              fontSize: 18, color: active, fontWeight: FontWeight.w500
          )),
        ),
        Container(
          ...
          child: Container(
            child: Text(desc, style: TextStyle(
                fontSize: 15, color: active,letterSpacing: 0.5
            )),
          ),
        ),
        Container(
            ...
            children: [
              ...
              Flexible(
                  ...
                  child: Container(
                      ...
                      child: Icon(icon, size: 50, color: active))
              )
            ],
          ),
        ),
          ...
          child: new Opacity(
            ...
            child: new Container(
              ...
              child: CircularProgressIndicator(
                valueColor: new AlwaysStoppedAnimation<Color>(active),
                strokeWidth: 2.0,
              ),
            ),
          ),
